...
public class TodoH2Service implements TodoRepository{
    ...
    public Todo addTodo(Todo todo){
        ...
        Todo savingTodo = db.queryForObject("select * from TODOLIST where todo = ? and status = ? and priority = ?", new TodoRowMapper(), todo.getTodo(), todo.getStatus(), todo.getPriority());
        return savingTodo;
    }
    @Override 
